...
library(readr)
gcse_english_and_maths_national_data_2019_20 <- read_csv("gcse-english-and-maths-national-data-2019-20.csv")
View(gcse_english_and_maths_national_data_2019_20)
```
...
## Examine the relationship between groups with different characteristics and GCSE English and maths scores
